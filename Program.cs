...
namespace _2122_Senior_Project_06
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("User inputted password: SuitablePassword007")
            Sys_Security.printBool(verify_newAcc);
            Console.WriteLine();

            Console.WriteLine("Verifies password with soed password; True = vaild, False = invalid");
            bool verify_pass = Sys_Security.Verify_Pass("SecurePasscode01", Sys_Security.SHA256_Hash("SecurePasscode01"));
            Console.WriteLine("User inputted password: SecurePasscode01")
